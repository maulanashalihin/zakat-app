...
<svelte:head>
  <title>Profile - {data.organization.name} | ZakatApp</title>
</svelte:head>
...
<div class="min-h-screen p-4 lg:p-8">
  <div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-8">
      <h1 class="text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Profile Settings</h1>
      ...
      <div class="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/40 dark:border-slate-700/40 shadow-[0_20px_50px_rgb(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgb(0,0,0,0.4)] rounded-[2rem] p-8">
        <div class="flex flex-col sm:flex-row items-start gap-6">
          <div class="relative">
            ...
            {:else if user.avatar}
              <img src={user.avatar} alt={user.name} class="w-24 h-24 rounded-2xl object-cover shadow-lg" />
            {:else}
              <div class="w-24 h-24 rounded-2xl flex items-center justify-center text-3xl font-extrabold shadow-lg bg-gradient-to-br from-primary-400 to-primary-600 text-white">
