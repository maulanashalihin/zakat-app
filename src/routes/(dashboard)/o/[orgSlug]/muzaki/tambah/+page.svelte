...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 p-3 sm:p-4 lg:p-8">
  ...
  <div class="max-w-3xl mx-auto mb-8">
    ...
    <div class="flex items-center gap-4 mb-2">
      <div class="w-10 h-10 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center shadow-lg shadow-primary-500/40">
        <Users class="w-7 h-7 text-white" />
      </div>
      <div>
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Tambah Muzaki</h1>
